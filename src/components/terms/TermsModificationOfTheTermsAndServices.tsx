interface TermsModificationOfTheTermsAndServicesProps { companyName: string; updatedAt: string }

/** Terms section: Modification of the Terms and Services */
export function TermsModificationOfTheTermsAndServices({ companyName, updatedAt }: TermsModificationOfTheTermsAndServicesProps) {
  return (
    <>
